...
#install cf
wget https://raw.githubusercontent.com/yusuf2010847/yusuf/main/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/yusuf2010847/yusuf/main/register"
# USERNAME
rm -f /usr/bin/user
...
function menu(){
    ...
    wget https://raw.githubusercontent.com/yusuf2010847/yusuf/main/menu/menu.zip
    unzip menu.zip
    chmod +x menu/*
